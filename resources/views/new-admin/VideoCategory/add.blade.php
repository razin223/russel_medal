        ...
        <div class="card">
            <div class="card-body">
                <p class="text-center bg-warning">
                    <?php
                    $MaxSerial = \App\VideoCategory::orderBy('serial', 'desc')->first();
                ...
                <form id="form" onsubmit="return false;" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3  col-md-2 col-form-label">Video Category Name <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="video_category_name" class="form-control" id="exampleInputEmail2" >
                        </div>
                    </div>
