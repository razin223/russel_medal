...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#form").submit(function (event) {
            ...
            $.ajax({
                url: "{{route('educationlevel_edit',$id)}}",
                method: "POST",
...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <?php
                $Data = \App\EducationLevel::find($id);
                ...
                if ($Data != NULL) {
                    ...
                    <form id="form" onsubmit="return false;" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="education_level_name" value="{{$Data->education_level_name}}"  class="form-control" id="exampleInputUsername2" placeholder="Education Level name">
                            </div>
