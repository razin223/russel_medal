...
<html lang="en">
    <head>
        ...
        <title>Mujib Olympiad: @yield('title','Email Verify')</title>
        <!-- plugins:css -->
                    ...
                    <div class="row flex-grow">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left p-5">
                                ...
                                <h6 class="font-weight-light text-center">Lost verification email? Enter email address.</h6>
                                @include('new-admin.fixed-layout.message')
                                <form class="pt-3" method="POST" action="<?php echo route('en.email_verify_resend') ?>">
                                    @csrf
                                    ...
                                    <div class="mt-3">
                                        <input type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="Resend Verification Email" style="background-color: #1B783C; border-radius: 10px"/>
                                    </div>
