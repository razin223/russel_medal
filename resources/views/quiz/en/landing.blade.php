...
<meta property="og:title"              content="Mujib Olympiad" />
<meta property="og:description"        content="Mujib Olympiad is organizaed to spread about the father of the nation among national and international people. People will learn about our beloved leader Father of the Nation Sheikh Mujibur Rahman." />
                ...
                <div class="col-md-6" id="">
                    <div class="row text-center">
                        ...
                        <div class="text-center landing_image" style="height: 380px; overflow: hidden">
                            <img src='{{asset("assets/img/prize_eng.jpeg")}}'/>
                        </div>

                        <!--                        <div class="col-12 mt-3"  style=" font-family: 'Hind Siliguri'">
                                                    <h3 class="text-dark">MUJIB OLYMPIAD</h3>
                                                    <h4>Bangabandhu and Bangladesh Practice</h4>
                                                </div>-->
                        <?php
                        if (time() < strtotime("2021-06-25 14:55:00+06:00") || time() > strtotime("2021-06-25 23:59:59+06:00")) {
                            ...
                            <!--                            <div class="col-12 text-center" style=" font-family: 'Hind Siliguri'">
                                                            <h5 class="text-dark w-100 text-center">To Participate Get Registered</h5> 
                                                            <a href="{{route('register')}}" class="btn btn-info btn-lg text-white shadow-lg" style=" font-size: 1.75rem">REGISTER</a>
                                                        </div>-->
                            <?php
                        } else {
                            ?>
                            <!--                            <div class="col-12 text-center" style=" font-family: 'Hind Siliguri'">
                                                            <h5 class="text-dark w-100 text-center">Participate the Quiz.</h5> 
                                                            <a href="{{route('quiz')}}" class="btn btn-info btn-lg text-white shadow-lg" style=" font-size: 1.75rem">Quiz</a>
                                                        </div>-->
                            <?php
                        }
                        ?>
                        <!--                        <div class="col-12 text-center mt-5" style=" font-family: 'Hind Siliguri'">
                                                    <h3 class=" w-100 text-center text-info">Quiz has been completed successfully. Result will be announced soon.</h3> 
                                                                                    <a href="{{route('quiz')}}" class="btn btn-info btn-lg text-white shadow-lg" style=" font-size: 1.75rem">কুইজ</a>
                                                </div>-->

                        <!--                        <div class="col-12 text-center mt-4" >
                        
                                                    <p style="margin-bottom: 0px"><span style="font-size: 1.5rem">25 JUNE</span>&nbsp;&nbsp;&nbsp;Quiz will be available From 3PM to 12AM</p>
                                                </div>-->
...
if (time() > strtotime("2021-07-05 13:30:00+06:00")) {
    ...
    <section class="bg-white">
        <div class="container">
            <div class="row">
                <h2 class="section-title w-100 text-center text-bold"><strong>MUJIB OLYMPIAD WINNER</strong></h2>
                <div class="col-md-3">
...
<section class="testimonials section-bg" style="padding: 25px 0px;">
    <div class="container">
        <div class="row">
            <h2 class="section-title w-100 text-center text-bold"><strong>Learn About the Father of the Nation</strong></h2>
            <?php
                ...
                foreach ($Data as $value) {
                    ...
                    <div class="col-md-6 mb-2 mt-2 p-4">
                        <div class="row  bg-white">
                            <a href="{{route('en.content_list',$value->id)}}" class="text-dark w-100"><h5 class="m-4 p-2" style="border-bottom:solid lightgrey 2px;font-weight: bold">{{$value->category_name_en}}</h5></a>
                            <?php
                            $Take = 3;
                            $Content = $value->getContent()->where('featured', 'Yes')->where('language', 'En')->orderBy('display_order', 'asc')->take($Take)->get();
                            foreach ($Content as $key => $newvalue) {
                                ...
                                if ($key < 1) {
                                    ...
                                    <div class="col-12 mb-2 {{($key != $Take-1)? 'border-bottom':''}}">
                                        <div class="row">
                                            <div class="col-12">
                                                <a href="{{route('en.content_guest',$newvalue->id)}}" class="text-info">
                                                    <div class="media p-1">
...
<section class="bg-white">
    <div class="container">
        <div class="row">
            <h2 class="section-title w-100 text-center text-bold"><strong>Photo Gallery</strong></h2>
            ...
            <div class="col-md-12 text-center">
                <a href="{{(auth()->check())?route('en.photo_gallery'):route('en.photo_gallery')}}" class="btn btn-info rounded-lg p-3">See More </a>
            </div>
        </div>
    </div>
</section>
...
<section class=" testimonials section-bg">
    <div class="container">
        <div class="row">
            <h2 class="section-title w-100 text-center text-bold"><strong>Video Gallery</strong></h2>
            <div class="col-12">
                <div class="row">
                    <?php
            ...
            <div class="col-md-12 text-center">
                <a href="{{(auth()->check())?route('en.video_gallery'):route('en.video_gallery')}}" class="btn btn-info rounded-lg p-3">See More </a>
            </div>
        </div>
    </div>
</section>
