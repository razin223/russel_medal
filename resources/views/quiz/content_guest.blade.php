            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-center mb-5">
                        <a href="https://www.facebook.com/sharer.php?u={{urlencode(route('content_guest',$id))}}" title="ফেসবুকে শেয়ার করুন" class="p-2 bg-primary text-white rounded"><i class="icofont-facebook"></i></a>
                        <a href="https://twitter.com/intent/tweet?url={{urlencode(route('content_guest',$id))}}&text={{urlencode($Data->title)}}" title="টুইটারে শেয়ার করুন" class="p-2 bg-info text-white rounded"><i class="icofont-twitter"></i></a>
                    </div>
