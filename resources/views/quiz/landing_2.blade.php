        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" id="">
                    <div class="row text-center">
                        ...
                        <div class="col-12 text-center mt-4" >
                            ...
                            <p style="margin-bottom: 0px"><span style="font-size: 1.5rem">২৫ জুন</span>&nbsp;&nbsp;&nbsp;দুপুর ৩ টা থেকে শুরু হতে যাচ্ছে</p>
                        </div>
                ...
                <div class="col-md-6" id="landing_image_container">
                    ...
                    <div class="text-center landing_image" style="height: 400px; overflow: hidden">
...
<!--<section style=" background-color: #fff; padding: 20px;">
    <div class="container">
        <img src="{{asset('assets/img/home_bg.jpeg')}}" class="img-fluid"/>
    </div>
</section>-->
                ...
                foreach ($Data as $value) {
                    ...
                    <div class="col-md-6 mb-2 mt-2 p-4">
                        <div class="row  bg-white">
                            ...
                            <?php
                            $Take = 3;
                            $Content = $value->getContent()->where('featured', 'Yes')->orderBy('display_order', 'asc')->take($Take)->get();
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <a href="{{(auth()->check())?route('photo_gallery'):route('register')}}" class="btn btn-info rounded-lg p-3">আরো দেখুন </a>
            </div>
        </div>
    </div>
</section>
...
<section class=" testimonials section-bg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <a href="{{(auth()->check())?route('video_gallery'):route('register')}}" class="btn btn-info rounded-lg p-3">আরো দেখুন </a>
            </div>
        </div>
    </div>
</section>
